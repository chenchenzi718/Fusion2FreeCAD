...
App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNC").addGeometry(Part.LineSegment(App.Vector(-1.90500000000000,0.51000000000000,0.00000000000000),App.Vector(-1.90500000000000,1.01000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNC").addGeometry(Part.LineSegment(App.Vector(-3.67500000000000,1.01000000000000,0.00000000000000),App.Vector(-1.90500000000000,1.01000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNC").addGeometry(Part.LineSegment(App.Vector(-3.67500000000000,0.51000000000000,0.00000000000000),App.Vector(-3.67500000000000,1.01000000000000,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNG").addGeometry(Part.LineSegment(App.Vector(0.88500000000000,0.51000000000000,0.00000000000000),App.Vector(0.88500000000000,1.01000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNG").addGeometry(Part.LineSegment(App.Vector(0.88500000000000,1.01000000000000,0.00000000000000),App.Vector(-0.88500000000000,1.01000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNG").addGeometry(Part.LineSegment(App.Vector(-0.88500000000000,1.01000000000000,0.00000000000000),App.Vector(-0.88500000000000,0.51000000000000,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNK").addGeometry(Part.LineSegment(App.Vector(3.67500000000000,0.51000000000000,0.00000000000000),App.Vector(3.67500000000000,1.01000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNK").addGeometry(Part.LineSegment(App.Vector(3.67500000000000,1.01000000000000,0.00000000000000),App.Vector(1.90500000000000,1.01000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F97AqmpEfQPuM2A_1_JNK").addGeometry(Part.LineSegment(App.Vector(1.90500000000000,1.01000000000000,0.00000000000000),App.Vector(1.90500000000000,0.51000000000000,0.00000000000000)),False)
...
origin = App.Vector(-3.48500000000000,-1.77000000000000,-6.35000000000000)
x_axis=App.Vector(1.00000000000000,0.00000000000000,0.00000000000000)
y_axis=App.Vector(0.00000000000000,-1.00000000000000,0.00000000000000)
z_axis=App.Vector(0.00000000000000,0.00000000000000,-1.00000000000000)
rot = App.Rotation(x_axis,y_axis,z_axis)
...
App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRC").addGeometry(Part.LineSegment(App.Vector(2.98000000000000,0.25000000000000,0.00000000000000),App.Vector(3.99000000000000,0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRC").addGeometry(Part.LineSegment(App.Vector(3.99000000000000,0.25000000000000,0.00000000000000),App.Vector(3.99000000000000,-0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRC").addGeometry(Part.LineSegment(App.Vector(3.99000000000000,-0.25000000000000,0.00000000000000),App.Vector(2.98000000000000,-0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRC").addGeometry(Part.LineSegment(App.Vector(2.98000000000000,0.25000000000000,0.00000000000000),App.Vector(2.98000000000000,-0.25000000000000,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRG").addGeometry(Part.LineSegment(App.Vector(5.77000000000000,0.25000000000000,0.00000000000000),App.Vector(6.78000000000000,0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRG").addGeometry(Part.LineSegment(App.Vector(6.78000000000000,0.25000000000000,0.00000000000000),App.Vector(6.78000000000000,-0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRG").addGeometry(Part.LineSegment(App.Vector(6.78000000000000,-0.25000000000000,0.00000000000000),App.Vector(5.77000000000000,-0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRG").addGeometry(Part.LineSegment(App.Vector(5.77000000000000,0.25000000000000,0.00000000000000),App.Vector(5.77000000000000,-0.25000000000000,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRK").addGeometry(Part.LineSegment(App.Vector(0.19000000000000,0.25000000000000,0.00000000000000),App.Vector(1.20000000000000,0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRK").addGeometry(Part.LineSegment(App.Vector(1.20000000000000,0.25000000000000,0.00000000000000),App.Vector(1.20000000000000,-0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRK").addGeometry(Part.LineSegment(App.Vector(0.19000000000000,-0.25000000000000,0.00000000000000),App.Vector(1.20000000000000,-0.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_FD2xXQqTnFyaF1d_1_JRK").addGeometry(Part.LineSegment(App.Vector(0.19000000000000,0.25000000000000,0.00000000000000),App.Vector(0.19000000000000,-0.25000000000000,0.00000000000000)),False)

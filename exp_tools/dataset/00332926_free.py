...
App.ActiveDocument.getObject("Extrude_FMMs4ZpgDirTeZo_0_FtYa24UydzmTKWW_0_JGC").Length = 1123.95
...
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJG").addGeometry(Part.LineSegment(App.Vector(-59.17719000000000,317.50000000000000,0.00000000000000),App.Vector(49.65441999999999,317.50000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJG").addGeometry(Part.LineSegment(App.Vector(49.65441999999999,317.50000000000000,0.00000000000000),App.Vector(49.65441999999999,368.30000000000001,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJG").addGeometry(Part.LineSegment(App.Vector(-59.17719000000000,368.30000000000001,0.00000000000000),App.Vector(49.65441999999999,368.30000000000001,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJG").addGeometry(Part.LineSegment(App.Vector(-59.17719000000000,317.50000000000000,0.00000000000000),App.Vector(-59.17719000000000,368.30000000000001,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJK").addGeometry(Part.LineSegment(App.Vector(-44.21286000000000,730.25000000000000,0.00000000000000),App.Vector(49.65441999999999,730.25000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJK").addGeometry(Part.LineSegment(App.Vector(49.65441999999999,730.25000000000000,0.00000000000000),App.Vector(49.65441999999999,781.05000000000007,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJK").addGeometry(Part.LineSegment(App.Vector(-44.21286000000000,781.05000000000007,0.00000000000000),App.Vector(49.65441999999999,781.05000000000007,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJK").addGeometry(Part.LineSegment(App.Vector(-44.21286000000000,730.25000000000000,0.00000000000000),App.Vector(-44.21286000000000,781.05000000000007,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJO").addGeometry(Part.LineSegment(App.Vector(-74.14155000000000,469.89999999999998,0.00000000000000),App.Vector(71.42076999999999,469.89999999999998,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJO").addGeometry(Part.LineSegment(App.Vector(71.42076999999999,469.89999999999998,0.00000000000000),App.Vector(71.42076999999999,419.09999999999997,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJO").addGeometry(Part.LineSegment(App.Vector(-74.14155000000000,419.09999999999997,0.00000000000000),App.Vector(71.42076999999999,419.09999999999997,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJO").addGeometry(Part.LineSegment(App.Vector(-74.14155000000000,469.89999999999998,0.00000000000000),App.Vector(-74.14155000000000,419.09999999999997,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(-210.36203000000000,1073.15000000000009,0.00000000000000),App.Vector(132.79838999999998,1073.15000000000009,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(132.79838999999998,1073.15000000000009,0.00000000000000),App.Vector(132.79838999999998,1123.95000000000005,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(-210.36203000000000,1123.95000000000005,0.00000000000000),App.Vector(132.79838999999998,1123.95000000000005,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(-210.36203000000000,1073.15000000000009,0.00000000000000),App.Vector(-210.36203000000000,1123.95000000000005,0.00000000000000)),False)
...
App.ActiveDocument.recompute()
plane = App.ActiveDocument.getObject("Body_FMMs4ZpgDirTeZo_0").newObject("PartDesign::Plane", "plane_Sketch_F2dbSPU4KJOTJO1_1_JJW")
origin = App.Vector(0.00000000000000,0.00000000000000,0.00000000000000)
x_axis=App.Vector(1.00000000000000,0.00000000000000,0.00000000000000)
y_axis=App.Vector(-0.00000000000000,0.00000000000000,1.00000000000000)
z_axis=App.Vector(0.00000000000000,-1.00000000000000,0.00000000000000)
rot = App.Rotation(x_axis,y_axis,z_axis)
App.ActiveDocument.getObject("plane_Sketch_F2dbSPU4KJOTJO1_1_JJW").Placement = App.Placement(origin,rot)
App.ActiveDocument.getObject("Body_FMMs4ZpgDirTeZo_0").newObject("Sketcher::SketchObject","Sketch_F2dbSPU4KJOTJO1_1_JJW")
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").AttachmentSupport = (App.ActiveDocument.getObject("plane_Sketch_F2dbSPU4KJOTJO1_1_JJW"), [""])
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").MapMode = "FlatFace"
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").addGeometry(Part.LineSegment(App.Vector(-145.56876000000000,228.59999999999999,0.00000000000000),App.Vector(93.98041000000001,228.59999999999999,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").addGeometry(Part.LineSegment(App.Vector(93.98041000000001,228.59999999999999,0.00000000000000),App.Vector(93.98041000000001,279.39999999999998,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").addGeometry(Part.LineSegment(App.Vector(-145.56876000000000,279.39999999999998,0.00000000000000),App.Vector(93.98041000000001,279.39999999999998,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").addGeometry(Part.LineSegment(App.Vector(-145.56876000000000,228.59999999999999,0.00000000000000),App.Vector(-145.56876000000000,279.39999999999998,0.00000000000000)),False)

App.ActiveDocument.recompute()
detect_cnt=App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").detectMissingPointOnPointConstraints()
(App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW").makeMissingPointOnPointCoincident()) if detect_cnt>0 else None
App.ActiveDocument.recompute()
App.ActiveDocument.getObject("Body_FMMs4ZpgDirTeZo_0").newObject("PartDesign::Pocket","Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW")
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Profile = App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW")
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Length = 25.400000000000002
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").TaperAngle = 0.000000
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").UseCustomVector = 0
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Direction = (0, 0, 1)
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").ReferenceAxis = (App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJW"), ["N_Axis"])
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").AlongSketchNormal = 1
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Type = 0
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").UpToFace = None
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Reversed = 1
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Midplane = 0
App.ActiveDocument.getObject("Extrude_F2dbSPU4KJOTJO1_1_Fvfy45scU7o7925_1_JJW").Offset = 0
App.ActiveDocument.recompute()

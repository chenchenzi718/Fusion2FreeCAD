...
App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(-92.01760000000000,508.00000000000000,0.00000000000000),App.Vector(52.72916000000000,508.00000000000000,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(52.72916000000000,508.00000000000000,0.00000000000000),App.Vector(52.72916000000000,457.19999999999999,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(-92.01760000000000,457.19999999999999,0.00000000000000),App.Vector(52.72916000000000,457.19999999999999,0.00000000000000)),False)

App.ActiveDocument.getObject("Sketch_F2dbSPU4KJOTJO1_1_JJS").addGeometry(Part.LineSegment(App.Vector(-92.01760000000000,508.00000000000000,0.00000000000000),App.Vector(-92.01760000000000,457.19999999999999,0.00000000000000)),False)
...
App.ActiveDocument.getObject("Sketch_FQpHLrdhjftHe2C_1_JNG").addGeometry(Part.Circle(App.Vector(0.00000000000000,482.59999999999997,0.00000000000000),App.Vector(0.00000000000000,0.00000000000000,1.00000000000000),4.76250000000000),False)

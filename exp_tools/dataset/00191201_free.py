...
App.ActiveDocument.getObject("Sketch_FBe8kDdWslnqC6l_0_JGS").addGeometry(Part.Circle(App.Vector(-37.00000000000000,0.00000000000000,0.00000000000000),App.Vector(0.00000000000000,0.00000000000000,1.00000000000000),2.00000000000000),False)

App.ActiveDocument.getObject("Sketch_FBe8kDdWslnqC6l_0_JGS").addGeometry(Part.Circle(App.Vector(37.00000000000000,0.00000000000000,0.00000000000000),App.Vector(0.00000000000000,0.00000000000000,1.00000000000000),2.00000000000000),False)

App.ActiveDocument.getObject("Sketch_FBe8kDdWslnqC6l_0_JGS").addGeometry(Part.Circle(App.Vector(-25.00000000000000,0.00000000000000,0.00000000000000),App.Vector(0.00000000000000,0.00000000000000,1.00000000000000),5.00000000000000),False)
